...
import 'package:music_app/model/paypal_model.dart';
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  String itemName = 'Artist/Producer';
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    String totalAmount = '10.99';
    String subTotalAmount = '10.99';
    String shippingCost = '0';
    int shippingDiscountCost = 0;
    String? userFullName = userModel.fullName;
...
class PaypalPaymentRecord extends StatefulWidget {
  ...
  PaypalPaymentRecord({required this.onFinish});
...
class PaypalPaymentRecordState extends State<PaypalPaymentRecord> {
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    // checkout invoice details
    String totalAmount = '73.99';
    String subTotalAmount = '73.99';
    String shippingCost = '0';
    int shippingDiscountCost = 0;
    String? userFullName = userModel.fullName;
    String? userEmail = userModel.email;
